...
export default function SpecialTab2({
    image,
    owner,
    name,
    location,
    ...
    return (
        <div className="w-[340px] h-60 bg-white px-3 pt-3 pb-6 mb-6 mr-6 rounded-xl flex flex-col border-2 border-black border-opacity-20">
